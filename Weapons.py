...
class Weapon:
	...
	def __init__(self, name: str, damage_range: tuple[int, int], status_effect: str = None):
		self.name = name
		self.damage_range = damage_range
		self.average_damage = self.calc_average_dmg()
		self.status_effect: str = status_effect
		self.status_damage = self.status_damage_dict.get(self.status_effect, self.status_damage_dict[None])
	...
	def set_status(self, s=None):
		...
		self.status_damage = self.status_damage_dict.get(s, self.status_damage_dict[None])
